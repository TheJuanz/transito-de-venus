...
function generateQRCode(){
  ...
  if(el) el.textContent=url+'#simulacion';
  const img=new Image();
  ...
  img.src=`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(url+'%23simulacion')}&bgcolor=ffffff&color=000000&margin=2`;
}
